...
ENV PERSISTENCE_DURATION=10
ENV PERSISTENCE_CACHEDIR=

ENV GRPC_PORT=50051

ENV RTMP_PORT=1935
ENV RTMP_APPNAME=lives

ENV QUEUE_RTMPFORWARD=8192
ENV QUEUE_FLVRELAY=2048
ENV QUEUE_RTMPPUBLISH=4096
ENV QUEUE_SRTPACKET=4096
ENV QUEUE_CONTROL=1024
ENV QUEUE_EVENT=4096
